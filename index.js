...
const MENU_IMG = "https://files.catbox.moe/iw9ar0.jpg"
  ...
  const ownerNumber = ['237682698517','32466304227']
...
const port = process.env.PORT || 9090;
  ...
  console.log('SIGMA-MDX connected to whatsapp ✅')
  
  let up = `*╭──────────────●●►*
> *➺ sɪɢᴍᴀ ᴍᴅx ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴘʀɪɴᴄᴇ ✅*
...
conn.sendMessage(conn.user.id, { image: { url: MENU_IMG }, caption: up })
  ...
  try {
    if (config.WELCOME_ENABLED !== "true") return;
...
Let's make this group even more awesome together! 🙌✨`;
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('237677224245', '237682698517');
 ...
 //================ownerreact==============
  ...
  if(senderNumber.includes("23826985177")){
  if(isReact) return
  m.react("💚")
   }
  //==========public react============//
